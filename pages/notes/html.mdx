...
The `html` function is an example of a **tagged template literal** - for more info on how they work, check out [Wes Bos' intro][bos-ttls]
...
Bonus: If you're a VSCode user, you can use [es6-string-html][vsc-hi] plugin to get inline syntax highlighting for your `html` strings! 🔥

(And apparently [my website's syntax highlighter][rehype-prism] is smart enough to detect `html`, too! 🤯)
