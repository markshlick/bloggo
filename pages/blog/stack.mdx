export const meta = {
  pub: true,
  title: 'My publishing stack [WIP]',
  date: '2020-05-29T20:43:33Z',
  tags: ['meta', 'code'],
};
...
One of my favorite features of Next.js is it's out-of-the-box flexibility with imports - for instance, in my home page's `getStaticProps`, I [scan a directory for all MDX files with `fs`, dynamically `require` them , and aggregate the exported metadata][magic-imports] - then Next.js takes care of generating all the static content!
